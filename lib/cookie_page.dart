...
Widget _buildCard(String name,String imgPath,String price,bool added,bool isFavorite,context){
  return Padding(
          ...
          children:[
            Padding(
              ...
              child: Row(
                ...
                children:[isFavorite ? Icon(Icons.favorite,color:Color(0xFFEF7532))
